...
$(DOCKER_SYNCD_DNX_BASE)_LOAD_DOCKERS += $(DOCKER_CONFIG_ENGINE_TRIXIE)
$(DOCKER_SYNCD_DNX_BASE)_DBG_DEPENDS += $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_DEPENDS)
$(DOCKER_SYNCD_DNX_BASE)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_IMAGE_PACKAGES)
...
$(DOCKER_SYNCD_DNX_BASE)_DEPENDS += $(SSWSYNCD)
$(DOCKER_SYNCD_DNX_BASE)_FILES += $(RDB-CLI)
...
SONIC_TRIXIE_DOCKERS += $(DOCKER_SYNCD_DNX_BASE)
SONIC_TRIXIE_DBG_DOCKERS += $(DOCKER_SYNCD_DNX_BASE_DBG)
