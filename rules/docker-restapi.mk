...
$(DOCKER_RESTAPI)_DEPENDS += $(RESTAPI) $(LIBSWSSCOMMON) $(PYTHON3_SWSSCOMMON)
$(DOCKER_RESTAPI)_PYTHON_WHEELS += $(SONIC_CONFIG_ENGINE_PY3)

$(DOCKER_RESTAPI)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_DEPENDS)
$(DOCKER_RESTAPI)_DBG_DEPENDS += $(RESTAPI_DBG) $(LIBSWSSCOMMON_DBG)

$(DOCKER_RESTAPI)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_IMAGE_PACKAGES)

$(DOCKER_RESTAPI)_PATH = $(DOCKERS_PATH)/$(DOCKER_RESTAPI_STEM)

$(DOCKER_RESTAPI)_LOAD_DOCKERS += $(DOCKER_CONFIG_ENGINE_TRIXIE)
